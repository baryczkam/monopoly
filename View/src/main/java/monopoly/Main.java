...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        players = new Vector<>();
        newGame_window = new newGame_Window(players,board);
        newGame_window.createPlayer();
        game_window = new Game_Window(newGame_window);
        game_window.changePlayer();
        System.out.print(newGame_window.getPlayers().get(0).getPlayerName());
